...
import { Login, Register, Notification, About, Home, NotFoundPage, Schedule, Booking, CustomerList, PaymentList, Profile, Checkout, Wishlist, AirportList, TicketList, UserList} from '../../views'
const index = () => {
  return (
    <BrowserRouter>
      <Routes>
